...
public class Interaction implements Writeable, ToXContentObject {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, ToXContentObject.Params params) throws IOException {
        builder.startObject();
        builder.field(ConvoIndexConstants.CONVO_ID_FIELD, convoId);
        builder.field(ConvoIndexConstants.RESPONSE_INTER_ID_FIELD, id);
        ...
        builder.field(ConvoIndexConstants.INTER_ATTRIBUTES_FIELD, metadata);
        builder.endObject();
        return builder;
    }
